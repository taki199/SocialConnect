      ...
      {open && (
        ...
        <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <input type="text" placeholder={user.username||"Jhon"}className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" name="username"/>
          </div>
           {/* input */}
          <div className="flex flex-col gap-4">
        ...
        {/* input */}
          <div className="flex flex-col gap-4">
            ...
            <input type="text" placeholder={user.desc||"Out of Sight,Out of Mind."} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" name="desc"/>
          </div>
        ...
        {/* input */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <input type="text" placeholder={user.city||"Casablanca"} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" name="city"/>
          </div>
        ...
        {/* input */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <input type="text" placeholder={user.website||"Houcine.dev"} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" name="website" />
          </div>
        </div>
