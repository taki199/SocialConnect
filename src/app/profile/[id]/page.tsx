    ...
    <div className='flex gap-6 pt-6'>
      ...
      <div className="w-full lg:w-[70%] xl:w-[50%]">
        <div className="flex flex-col gap-6">
          <div className=" bg-slate-100   text-sm flex flex-col gap-6 mb-4">
            <div className="h-72 relative gap-2 ">
              ...
              <Image src="https://images.pexels.com/photos/27084455/pexels-photo-27084455/free-photo-of-arara.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" width={112} height={112} alt="" className="rounded-full object-cover w-28 h-28 absolute left-0 right-0 m-auto -bottom-6 ring-4 ring-white z-10" />
            </div>
            <div className="h-20 flex flex-col gap-4 items-center ">
              <span className="font-semibold p-2 text-2xl">Elva Weaver</span>
